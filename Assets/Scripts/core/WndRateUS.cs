...
public class WndRateUS : Window
{
	...
	{
		Analytics.SendEvent( "RATE_WND_CLICK_CLOSE", "day", Stats.Instance.DaysFromStart(), "level", Stats.Instance.level );
	...
	public void onClickRateUS()
	{
		...
		if( m_starsRate == 5 )
			Application.OpenURL( WndMainMenu.GetMyURL() );

		Analytics.SendEvent( "RATE_WND_RATE_US", "day", Stats.Instance.DaysFromStart(), "level", Stats.Instance.level, "stars", m_starsRate );
